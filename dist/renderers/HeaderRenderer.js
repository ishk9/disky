...
class HeaderRenderer {
    ...
    render(options = {}) {
        ...
        if (options.watchMode) {
            ...
            titleLine = `│  ${Colors_1.Colors.brand(title)}${' '.repeat(this.BOX_WIDTH - titleVisualLen - 2)}│`;
        }
        const taglineLine = `│  ${Colors_1.Colors.tagline(tagline)}${' '.repeat(this.BOX_WIDTH - tagline.length - 2)}│`;
